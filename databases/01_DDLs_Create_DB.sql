...
/****** Object:  Database [WorkersDb]    Script Date: 21/4/2025 11:58:54 ******/
CREATE DATABASE [WorkersDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'WorkersDb', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\WorkersDb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'WorkersDb_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\WorkersDb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [WorkersDb] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [WorkersDb] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [WorkersDb] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [WorkersDb] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [WorkersDb] SET QUERY_STORE = OFF
GO
